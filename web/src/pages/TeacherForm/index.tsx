...
function TeacherForm() {
  ...
  function createCreateClass(e: FormEvent) {
    e.preventDefault();
    ...
    api.post('classes', {
      ...
      alert('Erri ao realizar sucesso!');
    });
  }
  ...
  return (
    <div id="page-teacher-form" className="container">
      <PageHeader 
        ...
        description="O primeiro passo é precher esse formulário de inscrição."
      />

      <main>
        <form onSubmit={createCreateClass}>
          <fieldset>
